...
const MOCK_OPPORTUNITIES: OpportunityItem[] = [
  {
    ...
    workflowSteps: [
      { id: 'ws-1', title: 'Draft updates', status: 'completed' },
      { id: 'ws-2', title: 'Custodian approval', status: 'active', progress: '50%' },
      { id: 'ws-3', title: 'Program manager signoff', status: 'pending' },
    ],
  },
  {
    id: 'opp-002',
    ...
    stageStatus: 'Draft',
    workflowSteps: [
      { id: 'ws-1', title: 'Draft updates', status: 'active', progress: '30%' },
      { id: 'ws-2', title: 'Custodian approval', status: 'pending' },
      { id: 'ws-3', title: 'Program manager signoff', status: 'pending' },
    ],
  },
  {
    ...
    workflowSteps: [
      { id: 'ws-1', title: 'Draft updates', status: 'completed' },
      { id: 'ws-2', title: 'Custodian approval', status: 'completed' },
      { id: 'ws-3', title: 'Program manager signoff', status: 'completed' },
    ],
  },
  {
    id: 'opp-004',
    ...
    workflowSteps: [
      { id: 'ws-1', title: 'Draft updates', status: 'completed' },
      { id: 'ws-2', title: 'Custodian approval', status: 'active', progress: '75%' },
      { id: 'ws-3', title: 'Program manager signoff', status: 'pending' },
    ],
  },
  {
    ...
    stageStatus: 'Draft',
    workflowSteps: [
      { id: 'ws-1', title: 'Draft updates', status: 'active', progress: '10%' },
      { id: 'ws-2', title: 'Custodian approval', status: 'pending' },
      { id: 'ws-3', title: 'Program manager signoff', status: 'pending' },
    ],
  },
  {
    ...
    workflowSteps: [
      { id: 'ws-1', title: 'Draft updates', status: 'completed' },
      { id: 'ws-2', title: 'Custodian approval', status: 'active', progress: '60%' },
      { id: 'ws-3', title: 'Program manager signoff', status: 'pending' },
    ],
  },
  {
