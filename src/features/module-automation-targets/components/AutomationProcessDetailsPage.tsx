...
import ProcessDetailActionBar from './processDetails/ProcessDetailActionBar'
import ProcessDetailHeader from './processDetails/ProcessDetailHeader'
import FieldCommentSheet from './processDetails/FieldCommentSheet'
...
const AutomationProcessDetailsPage = () => {
  ...
  const { isCommentMode, selectedField, setIsCommentMode, clearField } =
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="flex items-center gap-3">
            ...
            <ProcessDetailActionBar processId={processId ?? ''} activeTab={activeTab} />
          </div>

          {/* ── Tab content + field comment panel ─────────────────────── */}
          <div className="mt-6 flex gap-4">
            <div className="min-w-0 flex-1 rounded-2xl bg-[linear-gradient(90.49deg,rgba(78,241,228,0.1)_0.03%,rgba(17,24,39,0.1)_99.89%)] p-[1px]">
              <div className="relative rounded-2xl bg-white p-6">
                ...
                {activeTab === 'TargetRecommendations' && (
                  <TargetRecommendationsTab process={data} />
                )}
