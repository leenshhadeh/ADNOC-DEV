...
import { ProcessDetailActionsProvider } from '../context/ProcessDetailActionsContext'
    ...
    <ProcessDetailActionsProvider>
      <div className="flex flex-col gap-0 overflow-hidden px-6">
        ...
        <div className="mb-6 flex items-center py-3">
          {!isLoading && data && (
            <h1 className="text-foreground text-2xl font-bold">{data.name}</h1>
          )}
        </div>
